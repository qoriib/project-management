  ...
  `),
    ...
    deliveries: SeedDelivery[] = [
      ...
      },
      {
        ...
        items: [{ poDate: "2026-04-05", itemName: "Granit Tile 60x60 (Cream)", qty: 40 }],
        poDate: "2026-04-05",
      },
      ...
      // PO 10: poDate=2026-05-15
      {
        ...
        items: [{ poDate: "2026-05-15", itemName: "Besi Beton Ulir 16mm x 12m", qty: 200 }],
        poDate: "2026-05-15",
      },
      {
    ...
    if (!exists) {
      ...
      if (resolvedItems.length > 0) {
        ...
        await deliveryRepo.createWithItems(
          { delivery_code: generatedCode, delivery_date: d.deliveryDate, po_id: poId },
          resolvedItems,
        );
      }
    }
