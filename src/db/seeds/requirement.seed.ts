...
export async function seedRequirements(): Promise<void> {
  ...
  const rawReqs: SeedRequirementRaw[] = [
    ...
    { itemName: "Mandor", price: 250000, projectName: p1, qty: 14, hasTax: false },
    {
    ...
    { itemName: "Pasir Beton", price: 300000, projectName: p1, qty: 15, hasTax: false },
    {
    ...
    { itemName: "Kawat Bendrat", price: 22000, projectName: p1, qty: 20, hasTax: false },
    {
    ...
    { itemName: "Kaso 5/7 Meranti", price: 35000, projectName: p1, qty: 200, hasTax: false }, // 100 + 100
    {
    ...
    { itemName: "Pasir Pasang", price: 250000, projectName: p1, qty: 20, hasTax: false },
    {
    ...
    { itemName: "Semen Putih 40 Kg", price: 85000, projectName: p1, qty: 10, hasTax: true },
    {
    ...
    { itemName: "Kabel NYM 3x2.5mm", price: 650000, projectName: p1, qty: 5, hasTax: true },
    {
    ...
    { itemName: "Pasir Pasang", price: 250000, projectName: p3, qty: 50, hasTax: false },
    {
  ...
  for (const b of rawReqs) {
    ...
    if (!matchedPrice) {
      console.warn(`No item_prices found for item '${b.itemName}'. Skipping Requirement.`);
      continue;
    }
