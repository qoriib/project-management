...
| 4   | **Pemilihan Material**     | Belum dipilih (`""`)           | Pada baris item order, biarkan kolom Material kosong.                     | Error: _"Material harus dipilih."_, baris item tidak bisa ditambahkan.                     |
| 5   | **Pemilihan Harga**        | Belum dipilih (`""`)           | Pilih material tetapi tidak memilih varian harga satuan.                  | Error: _"Variasi harga harus dipilih."_, baris item belum valid.                           |
| 6   | **Pemilihan Vendor**       | Belum dipilih (`""`)           | Pilih material & harga, tetapi biarkan kolom Vendor kosong.               | Error: _"Vendor harus dipilih."_, baris item belum valid.                                  |
| 7   | **Volume / Qty**           | `-1` atau `-5` (Negatif)       | Masukkan angka negatif pada kolom Volume item order.                      | Error: _"Volume tidak valid."_, tombol simpan item mati.                                   |
| 8   | **Volume / Qty**           | `0` (Nol)                      | Masukkan angka `0` pada kolom Volume item order.                          | Error: _"Volume tidak valid."_ (Volume pemesanan minimal $> 0$).                           |
| 9   | **Volume / Qty**           | `0.01` (Batas minimum desimal) | Masukkan angka desimal kecil `0.01`.                                      | Valid, baris item dapat disimpan.                                                          |
| 10  | **Volume / Qty**           | `100` (Angka normal)           | Masukkan angka volume pemesanan normal.                                   | Valid, subtotal dihitung otomatis (`Volume × Harga Satuan`).                               |
