...
|  5  | **Prefix**        | `"1"` atau `"@"` (Non-huruf)        | Ketik angka atau simbol di kolom Prefix.                                | Error: _"Prefix harus berupa 1 huruf."_, tombol Simpan mati.             |
|  6  | **Nama Kategori** | `""` (Kosong)                       | Isi Prefix `"K"`, lalu kosongkan kolom Nama Kategori.                   | Error: _"Nama kategori harus diisi."_, tombol Simpan mati.               |
