...
|:---:|---|---|---|---|
| 1 | **Harga (Rp)** | `-1` atau `-5000` (Negatif) | Masukkan angka negatif pada input Harga. | Error: *"Harga tidak valid."*, tombol **Tambah** mati (*disabled*). |
...
| 7 | **Proteksi Hapus** | Harga yang sudah terikat transaksi | Arahkan mouse ke tombol Hapus pada harga yang sudah digunakan. | Tombol Hapus mati (*disabled*) + muncul Tooltip: *"Harga ini sedang digunakan dan tidak bisa dihapus."* |
