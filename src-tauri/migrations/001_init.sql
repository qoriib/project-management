...
-- Kelompok kebutuhan (item pekerjaan) per proyek
-- has_detail = 1 → grup ini memiliki pagu (budget bisa NULL = pagu tanpa nominal, atau diisi = pagu dengan nominal)
-- has_detail = 0 → grup ini tidak menggunakan pagu
